...
var slide = {
    ...
    start2: function (folder) {
        ...
        $("#jwSlide_navi").css({
            "width": navi_img_width,
            "height": navi_img_height
        });
        $("#img_navi_5").css({
            "width": "74",
            "height": navi_img_height
    ...
    view: function (num, folder) {
        ...
        $("#img_navi_" + num).css({
            "margin": img_margin - img_border,
            "border": img_border + "px solid #B48C50",
            "opacity": "1"
        });
    ...
    btn_over: function (on) {
        if (on == "prev") {
            $("#jwSlide_left .btn").css({
                "opacity": "1"
            });
        } else if (on == "next") {
            $("#jwSlide_right .btn").css({
                "opacity": "1"
            });
        } else {
            $(".jwSlide_btn .btn").css({
